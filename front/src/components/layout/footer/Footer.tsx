...
const footerSections: FooterSection[] = [
  {
    title: "À propos",
    links: [{ label: "Notre Histoire" }, { label: "L'équipe" }],
  },
  {
    title: "Services",
    links: [
  ...
  {
    title: "Une question ?",
    links: [{ href: "/contact", label: "Contact" }, { label: "FAQ" }],
  },
  {
  ...
  return (
    <div className="border-b border-slate-600 last:border-b-0">
      ...
      >
        {section.title}
        {isOpen ? (
          <FaChevronCircleUp className="h-5 w-5" />
        ) : (
    ...
    >
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8 pt-8 border-t border-slate-600 text-center text-sm">
          <p>
            © {currentYear} EasyPlace. Notre équipe locale vous accompagne à
            chaque étape de votre présence digitale.
          </p>
        </div>
      </div>
    </footer>
